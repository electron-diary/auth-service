...
from app.application.user.command_handlers import DeleteUserCommandHandler, CreateUserCommandHandler, DeleteUserCommandHandler
from app.application.user.command_handlers import RestoreUserCommandHandler, UpdateContactsCommandHandler, UpdateUsernameCommandHandler
from app.application.user.query_handlers import GetUserActionsQueryHandler, GetUserByIdQueryHandler, GetUsersQueryHandler
...
@router.post('/create')
@inject
async def create_user(command: CreateUserCommand, handler: FromDishka[CreateUserCommandHandler]) -> None:
