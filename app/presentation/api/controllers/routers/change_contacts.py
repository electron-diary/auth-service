...
from app.application.commands.change_contacts import ChangeContacts, ChangeContactsCommand
...
async def change_contacts(
    use_case: FromDishka[ChangeContacts],
    command: ChangeContactsCommand,
) -> SuccessfulResponse:
